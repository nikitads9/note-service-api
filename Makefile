.PHONY: generate
generate:
	protoc -I api/note_v1 \
	-I proto --go_out=pkg/note_api \
	--go_opt=paths=import --go-grpc_out=pkg/note_api \
	--go-grpc_opt=paths=import --grpc-gateway_out=pkg/note_api \
	--grpc-gateway_opt=logtostderr=true \
	--grpc-gateway_opt=paths=import api/note_v1/note_v1.proto \
	--validate_out lang=go:pkg/note_api \
	--swagger_out=allow_merge=true,merge_file_name=api:pkg/note_api 
